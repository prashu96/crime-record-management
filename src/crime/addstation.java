...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        jButton7.setText("Add Station Info");
    ...
    String sql= "insert into station(INCHARGE,INAME,SNAME,LOCATION,PHONE) values (?,?,?,?,?)"; 
        try {
