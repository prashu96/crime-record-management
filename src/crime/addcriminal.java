...
PreparedStatement pst;
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Criminal Info");

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        jLabel8.setText("Offence Date");
    ...
    String sql= "insert into criminal(CNAME,AGE,GENDER,OFFENCE,OFFENCE_DATE,PLACE,DESCRIPTION) values (?,?,?,?,?,?,?)"; 
        try {
